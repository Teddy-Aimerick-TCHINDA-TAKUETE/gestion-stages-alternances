...
export const routes: Routes = [
  ...
  { path: 'admins/edit/:id', loadComponent: () => import('./ts/edit/admin-edit.component').then(m => m.AdminEditComponent) },
  ...
  { path: 'candidatures/edit/:id', loadComponent: () => import('./ts/edit/candidature-edit.component').then(m => m.CandidatureEditComponent) },
  ...
  { path: 'entreprises/edit/:id', loadComponent: () => import('./ts/edit/entreprise-edit.component').then(m => m.EntrepriseEditComponent) },
  ...
  { path: 'etudiants/edit/:id', loadComponent: () => import('./ts/edit/etudiant-edit.component').then(m => m.EtudiantEditComponent) },
  ...
  { path: 'stages/edit/:id', loadComponent: () => import('./ts/edit/stage-edit.component').then(m => m.StageEditComponent) },
  { path: 'stages/:id', component: StageDetailComponent },
  { path: 'users', component: UserListComponent },
  { path: 'users/create', component: UserFormComponent },
  { path: 'users/edit/:id', loadComponent: () => import('./ts/edit/user-edit.component').then(m => m.UserEditComponent) },
