...
export const routes: Routes = [
  ...
  { path: 'candidatures/create', component: CandidatureFormComponent, canActivate: [AuthGuard, RoleGuard], data: { roles: ['ADMIN', 'ENTREPRISE', 'ETUDIANT'] } },
  { path: 'candidatures/edit/:id', loadComponent: () => import('./ts/edit/candidature-edit.component').then(m => m.CandidatureEditComponent), canActivate: [AuthGuard, RoleGuard], data: { roles: ['ADMIN', 'ETUDIANT'] } },
  ...
  { path: 'stages', component: StageListComponent, canActivate: [AuthGuard, RoleGuard], data: { roles: ['ADMIN', 'ENTREPRISE', 'ETUDIANT'] } },
  { path: 'stages/create', component: StageFormComponent, canActivate: [AuthGuard, RoleGuard], data: { roles: ['ADMIN', 'ENTREPRISE', 'ETUDIANT'] } },
